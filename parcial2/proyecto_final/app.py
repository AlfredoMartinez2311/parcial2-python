...
def registro():
    ...
    cur = mysql.connection.cursor()
    cur.execute("SELECT * FROM tipo_usu")
    tipo = cur.fetchall()
    ...
    if request.method == 'GET':
        ...
        cur = mysql.connection.cursor()
        cur.execute("INSERT INTO users (name, email, password, id_tipo_usu, interes) VALUES (%s,%s,%s,%s,%s)", (name, email, password,tip,interes,))
